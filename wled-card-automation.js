...
class WledCard extends HTMLElement {
  ...
  setConfig(config) {
    ...
    this._autoToggle = config.auto_toggle || null;
...
_syncFromState(state) {
    ...
    if (!this._colourLocked && on && state.attributes.rgb_color) {
          ...
          <div class="card-inner" id="card-inner">
            <div class="header">
              ...
              <div style="display:flex;flex-direction:column;align-items:center;gap:2px;">
                ...
                <span style="font-size:9px;opacity:0.5;letter-spacing:0.05em;">${CARD_VERSION}</span>
              </div>
              <div style="display:flex;align-items:center;gap:5px;">
